...
const UserProfile = ({ userId, onBack, onUserClick }) => {
    ...
    return (
        <div className="animate-fadeIn">
            ...
            <button
                onClick={onBack}
                className="flex items-center gap-2 text-[#A6A6A6] hover:text-white mb-6 mt-8 transition-colors"
            >
                <ArrowLeft size={20} />
                <span>뒤로가기</span>
            </button>
            ...
            {/* 프로필 헤더 */}
            <div className="flex items-center gap-4 mb-8 bg-white/5 p-6 rounded-2xl border border-white/10">
                            ...
                            <div className="relative z-10">
                                ...
                                {(statistics.ascore != null || statistics.pscore != null || statistics.escore != null || statistics.fscore != null) && (
                                    <div className="mt-4 pt-4 border-t border-white/10">
                                        <div className="text-[#A6A6A6] text-xs mb-3 font-medium">상대방의 취향 점수</div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {cards.map(card => {
                        const cardData = {
                            ...
                            author: card.user?.nickname || profile?.nickname || 'User',
                            authorProfileUrl: card.user?.profileImageUrl || profile?.profileImageUrl || 'https://randomuser.me/api/portraits/lego/1.jpg',
